(function() {
    ...
    const CONFIG = {
        ...
        linkedinAPIs: {
            ...
            hunter: {
                key: 'YOUR_HUNTER_API_KEY', // Hunter.io for email discovery
            ...
            apollo: {
                key: 'YOUR_APOLLO_API_KEY', // Apollo.io API key
                endpoint: 'https://api.apollo.io/v1/people/search',
